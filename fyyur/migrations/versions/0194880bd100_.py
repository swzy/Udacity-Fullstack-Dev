...
Revision ID: 0194880bd100
Revises: 7b4f0a8f2213
Create Date: 2021-02-28 02:24:10.258885
...
revision = '0194880bd100'
down_revision = '7b4f0a8f2213'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('seeking_description', sa.BOOLEAN(), autoincrement=False, nullable=True),
